...
const TopNavBar = () => {
  ...
  const NAVLINKS = [
    ...
    { name: "Buscar", to: "/buscar" },
  ];

  const NavLinkClases = "text-on-surface-variant hover:text-primary/90 transition-colors font-label-md text-label-md px-2";
  return (
    <header className="bg-surface border-b border-outline-variant fixed top-0 w-full z-50">
      <div className="flex justify-between items-center px-margin-mobile md:px-margin-desktop h-16 w-full max-w-max-width mx-auto">
        <h1 className="text-headline-md font-headline-md text-primary tracking-tight">MercadoBarrio</h1>
