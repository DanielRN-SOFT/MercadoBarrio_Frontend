...
import { MdClose, MdOutlineDashboard, MdOutlineStore, MdOutlineGroup, MdOutlineSettings } from "react-icons/md";
import { Link, useLocation } from "react-router-dom";

const navItems = [
  { to: "/panel/admin", icon: <MdOutlineDashboard />, label: "Panel" },
  { to: "/panel/admin/tiendas", icon: <MdOutlineStore />, label: "Tiendas", filled: true },
